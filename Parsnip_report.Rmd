...
```{r eval=TRUE, out.width= '100%', fig.cap="Overview Map of Parsnip River Watershed fish passage restoration candidates.  High priority crossings are red, moderate priorities are orange and low priorities are grey. Forest tenure roads are orange. Details of sites provided in pop-up windows of crossings with photos currently provided for high priority sites."}
##--------lets map it-----------------------------------------------------------------------
