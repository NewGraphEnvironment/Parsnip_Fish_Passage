...
```{r eval = FALSE}
photo_metadata_site <- photo_metadata %>% 
  filter(crossing_id %in% c('125247', '125253', 'CV1'))
```
...
## Workflow Layout
Raw data is built from populated:
...
GPS tracks and GPS track points from field surveys.  
