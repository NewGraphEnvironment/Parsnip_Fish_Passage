...
Following office review, PSCIS stream crossing `r my_site` was ranked as a high priority for follow up with habitat confirmation due to the potential for rehabilitation of the crossing to provide access to modelled instream habitat (`r my_overview_info %>% pull(uphab_gross_sub22)`km) with a relatively large channel size (`r my_planning_data %>% pull(downstream_channel_width)`m) and Rainbow Trout documented upstream (Table \@ref(tab:table-planning)). The habitat confirmation was completed on September 4, 2019 (dowstream) and `r date` (upstream). A map of the watershed including areas surveyed is provided in Attachment 1 – Map [`r my_mapsheet`](`r my_map_link`).
...
my_caption = paste0('View of bridge (modelled crossing 16603641) located upstream of crossing ', my_site, ' (', get_photo_utm(), ').')
