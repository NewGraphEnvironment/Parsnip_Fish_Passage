...
table_overview_html_all <- function(df){
  ...
  reports_complete_withzeros = c('57681', '57690', '57695')
  df %>% 
...
make_table_planning <- function(planning_data){
  table_planning  <- planning_data %>% 
    ...
    transmute(Site = stream_crossing_id, 
              ...
              map_linked = paste0("[", dbm_mof_50k_grid_map_tile, "](", paste0('https://hillcrestgeo.ca/outgoing/forNewGraph/parsnip/maps/FishPassage_', sub("(.{4})(.*)", "\\1.\\2", dbm_mof_50k_grid_map_tile), '.pdf'), ")"), 
